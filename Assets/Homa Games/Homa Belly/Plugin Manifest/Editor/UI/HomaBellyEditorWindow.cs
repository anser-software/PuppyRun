...
namespace HomaGames.HomaBelly
{
    ...
    internal sealed class HomaBellyEditorWindow : EditorWindow, IHomaBellyWindowController
    {
        ...
        {
            EditorAnalytics.TrackEditorAnalyticsEvent("open_homa_belly_setup_from_menu");
        ...
        internal static void DeleteAllPackages()
        {
            ...
            if (manifest != null)
            {
                ...
                if (ensureDeletion)
                {
                    EditorAnalytics.TrackEditorAnalyticsEvent("delete_all_packages");
        ...
        {
            EditorAnalytics.TrackEditorAnalyticsEvent("open_homa_belly_implementation_guide");
        ...
        {
            EditorAnalytics.TrackEditorAnalyticsEvent("open_homa_belly_troubleshooting");
